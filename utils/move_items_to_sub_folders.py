#move_items_to_sub_folders
#give a base_path, divides folder items into sub folders, each containing 2500
#useful to divide image folder for captioning or caching

import os
import shutil


base_path = '/mnt/storage/projects/sdxl-train/ComicArtCommunity/ComicArtCommunity_005/'
...
def move_image_caption_pairs(base_path):
    ...
    if existing_sub_folders:
        ...
        if count_items_in_folder(last_sub_folder_path) >= 2500:
    ...
    max_items_per_folder = 2500  # Max items per sub-folder
